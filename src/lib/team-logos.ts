...
export function getClubTeamLogoObjectPath(schemaName: string, clubTeamId: string) {
  return `${schemaName}/club-teams/${clubTeamId}.webp`;
}

export function getClubTeamLogoUrl(clubTeamId: string) {
