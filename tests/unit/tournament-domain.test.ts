...
import { buildTournamentBestDefense, buildTournamentStandings } from "@/lib/domain/tournament-stats";
...
describe("tournament standings", () => {
  it("ordena por puntos, diferencia de gol, goles a favor y nombre", () => {
    ...
    const results = [
      { match_id: "match-1", home_score: 1, away_score: 0, mvp_player_id: null, mvp_player_name: "Uno", notes: null },
      { match_id: "match-2", home_score: 2, away_score: 1, mvp_player_id: null, mvp_player_name: "Dos", notes: null },
      { match_id: "match-3", home_score: 0, away_score: 0, mvp_player_id: null, mvp_player_name: "Tres", notes: null },
      { match_id: "match-4", home_score: 0, away_score: 0, mvp_player_id: null, mvp_player_name: "Cuatro", notes: null }
    ];
